    ...
    <footer className="relative bg-black text-zinc-600">
      <div className="container mx-auto flex flex-col flex-wrap px-5 py-24 md:flex-row md:flex-nowrap md:items-center lg:items-start">
        <div className="mx-auto w-64 flex-shrink-0 text-center md:mx-0 md:text-left">
          ...
          <a
            href="https://vercel.com/?utm_source=samarthtmsl&utm_campaign=oss"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
              className="mx-auto h-auto w-36 pt-4 sm:mx-0"
              viewBox="0 0 212 44"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <rect width="212" height="44" rx="8" fill="white" />
              <path
                ...
                fill="black"
              />
              <path d="M23.3248 13L32.6497 29H14L23.3248 13Z" fill="black" />
              <line
                x1="43.5"
                y1="2.18557e-08"
                x2="43.5"
